                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('user/register_user'); ?>">
                          <fieldset>
                              ...
                              <div class="form-group">
                                  <input class="form-control" placeholder="Roll number" name="user_roll" type="text" value="">
                              </div>

                              <div class="form-group">
                                  <select class="form-control" placeholder="Region" name="region" type="text" value="" required>
                                    <option value="">Select Your Region</option>
                                    <option value="himal">Himal</option>
                                    <option value="pahad">Pahad</option>
